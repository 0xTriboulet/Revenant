/*** Autogenerated by WIDL 8.5 from include/devicetopology.idl - Do not edit ***/
...
/*** IAudioLoudness methods ***/
static __WIDL_INLINE HRESULT IAudioLoudness_GetEnabled(IAudioLoudness* This,WINBOOL *pbEnabled) {
    return This->lpVtbl->GetEnabled(This,pbEnabled);
}
static __WIDL_INLINE HRESULT IAudioLoudness_SetEnabled(IAudioLoudness* This,WINBOOL bEnabled,LPCGUID pguidEventContext) {
...
/*** IAudioMute methods ***/
static __WIDL_INLINE HRESULT IAudioMute_SetMute(IAudioMute* This,WINBOOL bMute,LPCGUID pguidEventContext) {
    return This->lpVtbl->SetMute(This,bMute,pguidEventContext);
}
static __WIDL_INLINE HRESULT IAudioMute_GetMute(IAudioMute* This,WINBOOL *pbMute) {
...
/*** IAudioAutoGainControl methods ***/
static __WIDL_INLINE HRESULT IAudioAutoGainControl_GetEnabled(IAudioAutoGainControl* This,WINBOOL bEnabled,LPCGUID pguidEventContext) {
    return This->lpVtbl->GetEnabled(This,bEnabled,pguidEventContext);
}
static __WIDL_INLINE HRESULT IAudioAutoGainControl_GetMute(IAudioAutoGainControl* This,WINBOOL *pbEnabled) {
...
/*** IKsFormatSupport methods ***/
static __WIDL_INLINE HRESULT IKsFormatSupport_IsFormatSupported(IKsFormatSupport* This,PKSDATAFORMAT pKsFormat,DWORD cbFormat,WINBOOL *pbSupported) {
...
static __WIDL_INLINE HRESULT IConnector_IsConnected(IConnector* This,WINBOOL *pbConnected) {
...
static __WIDL_INLINE HRESULT IDeviceTopology_GetSignalPath(IDeviceTopology* This,IPart *pIPartFrom,IPart *pIPartTo,WINBOOL bRejectMixedPaths,IPartsList **ppParts) {
