/*** Autogenerated by WIDL 8.5 from include/dxgi.idl - Do not edit ***/
...
/*** IDXGISurface1 methods ***/
static __WIDL_INLINE HRESULT IDXGISurface1_GetDC(IDXGISurface1* This,WINBOOL discard,HDC *hdc) {
...
static __WIDL_INLINE HRESULT IDXGIOutput_TakeOwnership(IDXGIOutput* This,IUnknown *device,WINBOOL exclusive) {
...
static __WIDL_INLINE HRESULT IDXGISwapChain_SetFullscreenState(IDXGISwapChain* This,WINBOOL fullscreen,IDXGIOutput *target) {
    return This->lpVtbl->SetFullscreenState(This,fullscreen,target);
}
static __WIDL_INLINE HRESULT IDXGISwapChain_GetFullscreenState(IDXGISwapChain* This,WINBOOL *fullscreen,IDXGIOutput **target) {
...
static __WIDL_INLINE WINBOOL IDXGIFactory1_IsCurrent(IDXGIFactory1* This) {
