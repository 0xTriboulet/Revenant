/*** Autogenerated by WIDL 8.5 from include/wmcodecdsp.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IWMColorConvProps_QueryInterface(IWMColorConvProps* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IWMColorConvProps_AddRef(IWMColorConvProps* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IWMColorConvProps_Release(IWMColorConvProps* This) {
    return This->lpVtbl->Release(This);
}
/*** IWMColorConvProps methods ***/
static __WIDL_INLINE HRESULT IWMColorConvProps_SetMode(IWMColorConvProps* This,LONG mode) {
    return This->lpVtbl->SetMode(This,mode);
}
static __WIDL_INLINE HRESULT IWMColorConvProps_SetFullCroppingParam(IWMColorConvProps* This,LONG src_left,LONG src_top,LONG dst_left,LONG dst_top,LONG width,LONG height) {
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IWMValidate_QueryInterface(IWMValidate* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IWMValidate_AddRef(IWMValidate* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IWMValidate_Release(IWMValidate* This) {
    return This->lpVtbl->Release(This);
}
/*** IWMValidate methods ***/
static __WIDL_INLINE HRESULT IWMValidate_SetIdentifier(IWMValidate* This,GUID guidValidationID) {
