/*** Autogenerated by WIDL 8.5 from include/xmllite.idl - Do not edit ***/
...
static __WIDL_INLINE WINBOOL IXmlReader_IsDefault(IXmlReader* This) {
    return This->lpVtbl->IsDefault(This);
}
static __WIDL_INLINE WINBOOL IXmlReader_IsEmptyElement(IXmlReader* This) {
...
static __WIDL_INLINE WINBOOL IXmlReader_IsEOF(IXmlReader* This) {
...
static __WIDL_INLINE HRESULT IXmlWriter_WriteAttributes(IXmlWriter* This,IXmlReader *pReader,WINBOOL fWriteDefaultAttributes) {
...
static __WIDL_INLINE HRESULT IXmlWriter_WriteNode(IXmlWriter* This,IXmlReader *pReader,WINBOOL fWriteDefaultAttributes) {
    return This->lpVtbl->WriteNode(This,pReader,fWriteDefaultAttributes);
}
static __WIDL_INLINE HRESULT IXmlWriter_WriteNodeShallow(IXmlWriter* This,IXmlReader *pReader,WINBOOL fWriteDefaultAttributes) {
